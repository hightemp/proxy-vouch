            ...
            try:
                ...
                for name, variables in cases:
                    ...
                    try:
                        ...
                        settings = dict(url="http://127.0.0.1:1420/", fallbackUrl="", ipEcho=False, countryLookup=False, expectedStatus=200, bodyContains="ProxyVouch", concurrency=1, rateLimit=10, connectTimeoutMs=1000, attemptTimeoutMs=2000, totalTimeoutMs=5000, retries=0)
